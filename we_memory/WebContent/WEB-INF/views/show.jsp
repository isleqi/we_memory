...
<div id="sidebar" class="grid_8 last" >
 ...
 <%! String path;String photo_path;%>
              <%path=(String)request.getAttribute("path");photo_path=(String)request.getAttribute("photo_path"); %>
              <input type="hidden" id="type" value=<%=photo_path %>></input>
 <div>
<ul id="daoul" >  
<script charset="Shift_JIS" src="http://chabudai.sakura.ne.jp/blogparts/honehoneclock/honehone_clock_wh.js"></script> 
 <div class="date">
              <a id=<%if(path==null||path.equals("works")) out.write("time2"); else out.write("time"); %> style="margin-left: 50px;color: black;font-weight: bold;font-size: 25px">time</a>
...
<script>
     ...
     window.onbeforeunload=jiazai(type);
	 
          function jiazai(path){
           var json={'path':path};
         $.ajax({
         type: "post", 
         data:json,
